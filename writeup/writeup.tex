...
Here is the average performance comparison for the running times for the full game AI, with $n = 1$, on an actual board size of $19 \times 19$, for the first five steps. 
\begin{table}[H]
\centering
